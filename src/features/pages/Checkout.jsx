          ...
          <form className="bg-white px-5 py-12 mt-12">
            <div className="space-y-12">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <p className="mt-1 text-sm/6 text-gray-600">
                  Choose Address from existing Addresses
                </p>
                ...
                <div className="mt-10 space-y-10">
                  <fieldset>
                    ...
                    <h2 className="text-base/7 mt-8 font-semibold text-gray-900">
                      Payment Method
                    </h2>
                    <p className="mt-1 text-sm/6 text-gray-600">
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <div className="text-gray-500">
                            ...
                            <select className="inline-flex items-center justify-center w-9 h-8 border border-gray-500 rounded-md bg-white text-gray-900 font-semibold text-base mr-2">
